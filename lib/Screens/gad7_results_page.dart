      ...
      case 0:
        return RichText(
          text: TextSpan(
            ...
            children: [
              TextSpan(
                text: "InnerJoy suggests the following activities to enhance your mental well-being:\n\n",
              ),
      ...
      case 9:
        return RichText(
          text: TextSpan(
            ...
            children: [
              TextSpan(
                text: "InnerJoy suggests the following activities to foster mental well-being:\n\n",
              ),
              _boldText("Meditation Assistance (Audio Clips):"),
              TextSpan(
      ...
      case 14:
        return RichText(
          text: TextSpan(
            ...
            children: [
              TextSpan(
                text: "InnerJoy recommends the following activities to provide comprehensive mental health support:\n\n",
              ),
              _boldText("Meditation Assistance (Audio Clips):"),
              TextSpan(
